    ...
    <div id="avatarFallback" class="avatar-fallback" style="display: none;">
        <div class="avatar-initial"><%= usuario != null ? usuario.substring(0, 1).toUpperCase() : "U" %></div>
            ...
            <div class="greeting-text">
                <h1>Hola <%= usuario %>!</h1>
                <p>¿Listo para tu entrenamiento de hoy?</p>
            </div>
        </div>
            ...
            <div class="routines-grid">
                ...
                <div class="routine-card">
                    <div class="routine-header">
                        ...
                        <span class="routine-day">Lunes</span>
                    </div>
                    <p class="routine-exercises">Press banca, press inclinado, aperturas con mancuernas, flexiones</p>
                ...
                <div class="routine-card">
                    <div class="routine-header">
                        <h3>Rutina de Espalda</h3>
                        <span class="routine-day">Martes</span>
                    </div>
                    <p class="routine-exercises">Jalon al pecho, remo con barra, peso muerto, dominadas asistidas</p>
                    <div class="routine-stats">
                        <span>
                            <svg class="icon" viewBox="0 0 24 24" fill="currentColor" width="14" height="14">
                                <path d="M14 10H2v2h12v-2zm0-4H2v2h12V6zM2 16h8v-2H2v2zm19.5-4.5L23 13l-6.99 7-4.51-4.5L13 14l3.01 3 5.49-5.5z"/>
                ...
                <div class="routine-card">
                    <div class="routine-header">
                        ...
                        <span class="routine-day">Miércoles</span>
                    </div>
                    <p class="routine-exercises">Sentadillas, prensa, extensiones, femorales, elevación de talones</p>
                    <div class="routine-stats">
                        <span>
                            <svg class="icon" viewBox="0 0 24 24" fill="currentColor" width="14" height="14">
                                <path d="M14 10H2v2h12v-2zm0-4H2v2h12V6zM2 16h8v-2H2v2zm19.5-4.5L23 13l-6.99 7-4.51-4.5L13 14l3.01 3 5.49-5.5z"/>
